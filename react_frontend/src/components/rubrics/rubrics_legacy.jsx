      ...
      <Box sx={commonStyles.pageHeader}>
        <Box>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 0.5 }}>
            <Tooltip title="Back to Rubrics Hub" arrow>
              <IconButton
                onClick={() => navigate('/home/rubrics')}
                size="small"
                sx={{ mr: 1 }}
              >
                <ArrowBackIcon />
            ...
            <Chip label="Legacy" size="small" color="warning" sx={{ ml: 1 }} />
          </Box>
          <Typography variant="body2" sx={{ color: 'text.secondary', ml: 6 }}>
            Original category-based rubric system for assessments
          </Typography>
        </Box>

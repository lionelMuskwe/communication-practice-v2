"""
Base settings for Medical Communication Practice Platform
"""
import os
...
def read_secret(secret_name: str, fallback: str = None) -> str:
    ...
    try:
        ...
        return fallback or os.getenv(secret_name.upper())


# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = read_secret('secret_key', 'django-insecure-change-this-in-production')
...
OPENAI_API_KEY = read_secret('openai_key', os.getenv('OPENAI_KEY', ''))
OPENAI_MODEL = read_secret('openai_model', os.getenv('OPENAI_MODEL', 'gpt-4-turbo-preview'))
